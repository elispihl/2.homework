	...
	<div class="container">
        ...
        <form>    
			...
			<div class="row">
				 <div class="col-md-3 col-sm-6">
					 <div class="form-group">
						<label for="wholesale_price"> Price: </label><br>
			 ...
			 <div class="row">
				 <div class="col-md-3 col-sm-6">
					 <div class="form-group">
						<label for="retail_price">  E-mail: </label><br>
			 ...
			 <div class="row">
				 <div class="col-md-3 col-sm-6">
					 <div class="form-group">
						<label for="amount_of_sold_items"> Number: </label><br>
			...
			<div class="row">
				 <div class="col-md-3 col-sm-6">
					 <div class="form-group">
						<label for="taxes"> Gender: </label><br>
